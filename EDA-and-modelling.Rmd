...
```{r predictors}
ggplot(model5)+
  geom_line(lwd = 1.25, colour = "orange")+
  geom_point(size = 3, colour = "orange")+
  geom_point(aes(x = 6, y = 6.755926), size = 8, shape = 21, fill = "orange", col = "black")+
  labs(subtitle = "The most optimal model was that with 6 predictors")+
  scale_color_tron()+
  scale_fill_tron()+
  theme_ipsum_es()
```
