...
**Can we predict how long it would take to learn a piano piece based on a number of variables? If so, which variables influenced the price the most?**
...
* at the following [link](https://htmlpreview.github.io/?https://github.com/peterhontaru/piano-practice-prediction/blob/master/EDA and modelling), in HTML format
